  ...
  if (status === "success") {
    return (
      <div className="py-8 text-center">
        <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary-deep/10">
        ...
        <h1 className="text-2xl font-bold text-primary-deep">{t("successTitle")}</h1>
